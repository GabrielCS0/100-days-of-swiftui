...
struct ContentView: View {
    ...
    @State private var inputKeys = [kCIInputIntensityKey]
            ...
            .confirmationDialog("Select a filter", isPresented: $showingFilterSheet) {
                if inputImage != nil {
                    Group {
                        ...
                        Button("Effect Tonal") { setFilter(CIFilter.photoEffectTonal()) }
                        Button("Comic Effect") { setFilter(CIFilter.comicEffect()) }
                    }
                    Button("Cancel", role: .cancel) { }
                } else {
                    Button("Select a picture first") { showingImagePicker = true }
                }
            }
        }
    }
